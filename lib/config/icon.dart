...
Image driver_icon = Image.asset("assets/icon/driver.png");

Image des_icon = Image.asset("assets/icon/des.png");

Image pin_icon = Image.asset("assets/icon/pin.png");

Image pinoff_icon = Image.asset("assets/icon/pinoff.png");

Image man_icon = Image.asset("assets/icon/man.png");
